...
insert into student_courses (student_id, courses_id) values (20001, 10001);
insert into student_courses (student_id, courses_id) values (20002, 10001);
insert into student_courses (student_id, courses_id) values (20003, 10001);
insert into student_courses (student_id, courses_id) values (20001, 10003);

insert into review (id, rating, description, course_id) values (40001, '4.5', 'WOW!', 10001);
insert into review (id, rating, description, course_id) values (40002, '2', 'Not so WOW!', 10001);
insert into review (id, rating, description, course_id) values (40003, '3', null, 10003);
